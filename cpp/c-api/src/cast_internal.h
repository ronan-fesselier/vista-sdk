...
namespace dnv::vista::sdk::c
{
    ...
    static_assert(
        static_cast<int>(PositionValidationResult::InvalidGrouping) ==
        DNV_VISTA_SDK_POSITION_VALIDATION_INVALID_GROUPING);
    static_assert(static_cast<int>(PositionValidationResult::Valid) == DNV_VISTA_SDK_POSITION_VALIDATION_VALID);
    static_assert(static_cast<int>(PositionValidationResult::Custom) == DNV_VISTA_SDK_POSITION_VALIDATION_CUSTOM);
    ...
    inline transport::serialization::json::SerializableDocument* toSerializableDocumentMutable(
        dnv_vista_sdk_serializable_document_t* doc)
    {
        return reinterpret_cast<transport::serialization::json::SerializableDocument*>(doc);
    }
    ...
    inline dnv_vista_sdk_serializable_document_t* fromSerializableDocumentRefMutable(
        transport::serialization::json::SerializableDocument& doc)
    {
        return reinterpret_cast<dnv_vista_sdk_serializable_document_t*>(&doc);
    }
