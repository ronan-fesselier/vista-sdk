...
int dnv_vista_sdk_date_time_offset_from_string(const char* iso8601String, dnv_vista_sdk_date_time_offset_t* result)
{
    ...
    {
        c::setLastError("iso8601String and result must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return 0;
    }
    ...
    {
        c::setLastError("invalid ISO 8601 DateTimeOffset string", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return 0;
    }
