    ...
    const dnv_vista_sdk_local_id_query_builder_t* builder, const dnv_vista_sdk_gmod_path_t* primaryItem)
{
    ...
    {
        c::setLastError("builder and primaryItem must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
    ...
    const dnv_vista_sdk_local_id_query_builder_t* builder, const dnv_vista_sdk_gmod_path_t* secondaryItem)
{
    ...
    {
        c::setLastError("builder and secondaryItem must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
...
dnv_vista_sdk_local_id_query_builder_t* dnv_vista_sdk_local_id_query_builder_with_primary_item_nodes_builder(
    const dnv_vista_sdk_local_id_query_builder_t* builder, const dnv_vista_sdk_gmod_path_query_builder_t* nodesBuilder)
{
    if (builder == nullptr || nodesBuilder == nullptr)
    {
        c::setLastError("builder and nodesBuilder must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }

    const auto* w = toGmodPathQueryBuilderWrapper(nodesBuilder);
    if (w->variant != GmodPathQueryBuilderWrapper::Variant::Nodes)
    {
        c::setLastError("nodesBuilder is not a Nodes-variant handle", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }

    return c::cApiTryCatch<dnv_vista_sdk_local_id_query_builder_t*>([&]() {
        return fromLocalIdQueryBuilder(toLocalIdQueryBuilder(builder)->withPrimaryItem(w->builder->build()));
    });
}

dnv_vista_sdk_local_id_query_builder_t* dnv_vista_sdk_local_id_query_builder_with_primary_item_path_builder(
    const dnv_vista_sdk_local_id_query_builder_t* builder, const dnv_vista_sdk_gmod_path_query_builder_t* pathBuilder)
{
    if (builder == nullptr || pathBuilder == nullptr)
    {
        c::setLastError("builder and pathBuilder must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }

    const auto* w = toGmodPathQueryBuilderWrapper(pathBuilder);
    if (w->variant != GmodPathQueryBuilderWrapper::Variant::Path)
    {
        c::setLastError("pathBuilder is not a Path-variant handle", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
...
dnv_vista_sdk_local_id_query_builder_t* dnv_vista_sdk_local_id_query_builder_with_secondary_item_nodes_builder(
    const dnv_vista_sdk_local_id_query_builder_t* builder, const dnv_vista_sdk_gmod_path_query_builder_t* nodesBuilder)
{
    if (builder == nullptr || nodesBuilder == nullptr)
    {
    ...
    return c::cApiTryCatch<dnv_vista_sdk_local_id_query_builder_t*>([&]() {
        return fromLocalIdQueryBuilder(toLocalIdQueryBuilder(builder)->withSecondaryItem(w->builder->build()));
    });
}

dnv_vista_sdk_local_id_query_builder_t* dnv_vista_sdk_local_id_query_builder_with_secondary_item_path_builder(
    const dnv_vista_sdk_local_id_query_builder_t* builder, const dnv_vista_sdk_gmod_path_query_builder_t* pathBuilder)
{
    if (builder == nullptr || pathBuilder == nullptr)
    {
    ...
    const dnv_vista_sdk_local_id_query_builder_t* builder, const dnv_vista_sdk_metadata_tags_query_t* tags)
{
    ...
    {
        c::setLastError("builder and tags must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
...
const dnv_vista_sdk_metadata_tags_query_builder_t* dnv_vista_sdk_local_id_query_builder_tags_builder(
    const dnv_vista_sdk_local_id_query_builder_t* builder)
{
    if (builder == nullptr)
    {
    ...
    const auto& tags = toLocalIdQueryBuilder(builder)->tags();
    if (!tags.has_value())
        return nullptr;

    return fromMetadataTagsQueryBuilderRef(tags->builder());
}
