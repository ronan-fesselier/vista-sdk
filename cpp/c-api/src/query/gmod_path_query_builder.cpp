    ...
    const dnv_vista_sdk_gmod_path_query_builder_t* builder)
{
    ...
    if (path == nullptr)
    {
        c::setLastErrorMessage("builder is not a Path-variant handle");
        return nullptr;
    }
    ...
    const dnv_vista_sdk_gmod_path_query_builder_t* builder, const char* code, int matchAllLocations)
{
    ...
    {
        c::setLastErrorMessage("builder and code must not be null");
        return nullptr;
    }
    ...
    try
    {
        return fromGmodPathQueryBuilderWrapper(
            ...
            std::make_unique<GmodPathQueryBuilder::Path>(path->withNode(
                [&codeStr](const std::unordered_map<std::string, const GmodNode*>& nodes) -> const GmodNode* {
    ...
    int matchAllLocations)
{
    ...
    {
        c::setLastErrorMessage("builder and node must not be null");
        return nullptr;
    }
    ...
    if (nodes == nullptr)
    {
        c::setLastErrorMessage("builder is not a Nodes-variant handle");
        return nullptr;
    }
