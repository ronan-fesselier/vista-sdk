...
dnv_vista_sdk_location_builder_t* dnv_vista_sdk_location_builder_create(const dnv_vista_sdk_locations_t* locations)
{
    ...
    {
        c::setLastError("locations must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
...
const char* dnv_vista_sdk_location_builder_version(const dnv_vista_sdk_location_builder_t* builder)
{
    if (builder == nullptr)
    {
    ...
    return VisVersions::toString(toBuilder(builder)->version()).data();
}
    ...
    const dnv_vista_sdk_location_builder_t* builder, int number)
{
    ...
    return c::cApiTryCatch<dnv_vista_sdk_location_builder_t*>(
        [&]() -> dnv_vista_sdk_location_builder_t* { return fromBuilder(toBuilder(builder)->withNumber(number)); });
}
    ...
    const dnv_vista_sdk_location_builder_t* builder, char side)
{
    ...
    return c::cApiTryCatch<dnv_vista_sdk_location_builder_t*>(
        [&]() -> dnv_vista_sdk_location_builder_t* { return fromBuilder(toBuilder(builder)->withSide(side)); });
}
    ...
    const dnv_vista_sdk_location_builder_t* builder, char vertical)
{
    ...
    return c::cApiTryCatch<dnv_vista_sdk_location_builder_t*>(
        [&]() -> dnv_vista_sdk_location_builder_t* { return fromBuilder(toBuilder(builder)->withVertical(vertical)); });
}
    ...
    const dnv_vista_sdk_location_builder_t* builder, char transverse)
{
    ...
    return c::cApiTryCatch<dnv_vista_sdk_location_builder_t*>([&]() -> dnv_vista_sdk_location_builder_t* {
    ...
    const dnv_vista_sdk_location_builder_t* builder, const dnv_vista_sdk_location_t* location)
{
    ...
    {
        c::setLastError("builder and location must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
...
int dnv_vista_sdk_location_builder_number(const dnv_vista_sdk_location_builder_t* builder, int* outNumber)
{
    ...
    {
        c::setLastError("builder and outNumber must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return 0;
    }
...
int dnv_vista_sdk_location_builder_side(const dnv_vista_sdk_location_builder_t* builder, char* outSide)
{
    ...
    {
        c::setLastError("builder and outSide must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return 0;
    }
...
int dnv_vista_sdk_location_builder_vertical(const dnv_vista_sdk_location_builder_t* builder, char* outVertical)
{
    ...
    {
        c::setLastError("builder and outVertical must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return 0;
    }
...
int dnv_vista_sdk_location_builder_transverse(const dnv_vista_sdk_location_builder_t* builder, char* outTransverse)
{
    ...
    {
        c::setLastError("builder and outTransverse must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return 0;
    }
...
int dnv_vista_sdk_location_builder_longitudinal(const dnv_vista_sdk_location_builder_t* builder, char* outLongitudinal)
{
    ...
    {
        c::setLastError("builder and outLongitudinal must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return 0;
    }
    ...
    const dnv_vista_sdk_location_builder_t* builder, char code)
{
    ...
    return c::cApiTryCatch<dnv_vista_sdk_location_builder_t*>(
        [&]() -> dnv_vista_sdk_location_builder_t* { return fromBuilder(toBuilder(builder)->withCode(code)); });
}
