...
int dnv_vista_sdk_local_id_builder_equals(
    const dnv_vista_sdk_local_id_builder_t* a, const dnv_vista_sdk_local_id_builder_t* b)
{
    ...
    return (*toLocalIdBuilder(a) == *toLocalIdBuilder(b)) ? 1 : 0;
}
    ...
    const dnv_vista_sdk_local_id_builder_t* builder, const char* visVersion)
{
    ...
    {
        c::setLastError("builder and visVersion must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
    ...
    const dnv_vista_sdk_local_id_builder_t* builder, const dnv_vista_sdk_gmod_path_t* path)
{
    ...
    {
        c::setLastError("builder and path must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
...
dnv_vista_sdk_local_id_t* dnv_vista_sdk_local_id_builder_build(const dnv_vista_sdk_local_id_builder_t* builder)
{
    ...
    return c::cApiTryCatch<dnv_vista_sdk_local_id_t*>(
        [&]() -> dnv_vista_sdk_local_id_t* { return fromLocalIdValue(toLocalIdBuilder(builder)->build()); });
}
