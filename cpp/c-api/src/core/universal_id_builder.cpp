...
dnv_vista_sdk_universal_id_builder_t* dnv_vista_sdk_universal_id_builder_create(const char* visVersion)
{
    ...
    {
        c::setLastError("visVersion must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
...
int dnv_vista_sdk_universal_id_builder_equals(
    const dnv_vista_sdk_universal_id_builder_t* a, const dnv_vista_sdk_universal_id_builder_t* b)
{
    ...
    return (*toUniversalIdBuilder(a) == *toUniversalIdBuilder(b)) ? 1 : 0;
}
    ...
    const dnv_vista_sdk_universal_id_builder_t* builder, const dnv_vista_sdk_imo_number_t* imoNumber)
{
    ...
    {
        c::setLastError("builder and imoNumber must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
    ...
    const dnv_vista_sdk_universal_id_builder_t* builder, const dnv_vista_sdk_local_id_builder_t* localIdBuilder)
{
    ...
    {
        c::setLastError("builder and localIdBuilder must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
...
char* dnv_vista_sdk_universal_id_builder_to_string(const dnv_vista_sdk_universal_id_builder_t* builder)
{
    ...
    return c::cApiTryCatch<char*>([&]() -> char* { return toOwnedCString(toUniversalIdBuilder(builder)->toString()); });
}
    ...
    const char* universalIdStr, dnv_vista_sdk_parsing_errors_t** outErrors)
{
    ...
    {
        c::setLastError("universalIdStr and outErrors must not be null", DNV_VISTA_SDK_ERROR_INVALID_ARGUMENT);
        return nullptr;
    }
