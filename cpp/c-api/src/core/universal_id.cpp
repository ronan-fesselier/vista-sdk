...
int dnv_vista_sdk_universal_id_equals(const dnv_vista_sdk_universal_id_t* a, const dnv_vista_sdk_universal_id_t* b)
{
    ...
    return (*toUniversalId(a) == *toUniversalId(b)) ? 1 : 0;
}
