...
#include "../../../timeseries/time_series_data.h"
...
extern "C"
{
     ...
     *         dnv_vista_sdk_tsd_json_string_free, or NULL if `dataPackage` is NULL
     */
     ...
     * @param str String obtained from dnv_vista_sdk_tsd_data_package_to_json, may be NULL (no-op)
     */
    DNV_VISTA_SDK_C_API void dnv_vista_sdk_tsd_json_string_free(char* str);
