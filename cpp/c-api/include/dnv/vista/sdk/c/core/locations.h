...
extern "C"
{
     ...
     */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_location_t* dnv_vista_sdk_locations_from_string(
     ...
     */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_location_t* dnv_vista_sdk_locations_from_string_with_errors(
