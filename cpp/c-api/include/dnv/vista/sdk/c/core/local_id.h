...
extern "C"
{
    ...
    /**
     * @brief Compare two LocalId handles for equality
     * @param a First handle
     * @param b Second handle
     * @return 1 if both represent the same LocalId, 0 otherwise or if either is NULL
     */
    DNV_VISTA_SDK_C_API int dnv_vista_sdk_local_id_equals(
        const dnv_vista_sdk_local_id_t* a, const dnv_vista_sdk_local_id_t* b);
