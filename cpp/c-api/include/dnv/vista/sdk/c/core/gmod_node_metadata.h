...
extern "C"
{
    ...
    /**
     * @brief Compare two GmodNodeMetadata handles for equality
     * @param a First handle
     * @param b Second handle
     * @return 1 if both represent the same metadata, 0 otherwise or if either is NULL
     */
    DNV_VISTA_SDK_C_API int dnv_vista_sdk_gmod_node_metadata_equals(
        const dnv_vista_sdk_gmod_node_metadata_t* a, const dnv_vista_sdk_gmod_node_metadata_t* b);
