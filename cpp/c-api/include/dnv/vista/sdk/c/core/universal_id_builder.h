...
extern "C"
{
    ...
    /**
     * @brief Compare two UniversalIdBuilder handles for equality
     * @param a First handle
     * @param b Second handle
     * @return 1 if both represent the same builder state, 0 otherwise or if either is NULL
     */
    DNV_VISTA_SDK_C_API int dnv_vista_sdk_universal_id_builder_equals(
