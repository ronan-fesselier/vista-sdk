...
extern "C"
{
    ...
    /**
     * @brief Get the VIS version this builder validates against
     * @param builder Handle obtained from this API
     * @return Null-terminated version string, owned by the library - valid for the
     *         lifetime of the program, or NULL if `builder` is NULL
     */
    DNV_VISTA_SDK_C_API const char* dnv_vista_sdk_location_builder_version(
