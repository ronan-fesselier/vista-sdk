...
extern "C"
{
     ...
     *         dnv_vista_sdk_location_builder_string_free, or NULL if `builder` is NULL
     */
     ...
     * @param str String obtained from dnv_vista_sdk_location_builder_to_string, may be NULL (no-op)
     */
    DNV_VISTA_SDK_C_API void dnv_vista_sdk_location_builder_string_free(char* str);
