...
extern "C"
{
     ...
     *         dnv_vista_sdk_gmod_path_string_free, or NULL if `path` is NULL or not
     *         found at this depth
     */
     ...
     * @param index Zero-based index, must be < dnv_vista_sdk_gmod_path_common_name_count(path)
     * @return Owned, null-terminated string, must be released with
     *         dnv_vista_sdk_gmod_path_string_free, or NULL if `path` is NULL or
     ...
     * @param path Handle obtained from this API
     * @return Owned, null-terminated string, must be released with
     *         dnv_vista_sdk_gmod_path_string_free, or NULL if `path` is NULL
     */
     ...
     * @param str String obtained from a dnv_vista_sdk_gmod_path_to_*() function, may be NULL (no-op)
     */
    DNV_VISTA_SDK_C_API void dnv_vista_sdk_gmod_path_string_free(char* str);
