...
extern "C"
{
    ...
    /**
     * @brief Compare two GmodPath handles for equality
     * @param a First handle
     * @param b Second handle
     * @return 1 if both represent the same path, 0 otherwise or if either is NULL
     */
    DNV_VISTA_SDK_C_API int dnv_vista_sdk_gmod_path_equals(
        const dnv_vista_sdk_gmod_path_t* a, const dnv_vista_sdk_gmod_path_t* b);
