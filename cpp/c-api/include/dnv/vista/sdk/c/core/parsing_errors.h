...
extern "C"
{
    ...
    /**
     * @brief Create an empty ParsingErrors handle
     * @return Owned handle with zero errors, must be released with dnv_vista_sdk_parsing_errors_free
     */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_parsing_errors_t* dnv_vista_sdk_parsing_errors_create_empty(void);
     ...
     *         with dnv_vista_sdk_string_free, or NULL if `errors` is NULL
     */
