...
extern "C"
{
     ...
     * @param tag Handle obtained from this API
     * @return '~' for custom tags, '-' for standard tags, or '\0' if `tag` is NULL
     */
    DNV_VISTA_SDK_C_API char dnv_vista_sdk_metadata_tag_prefix(const dnv_vista_sdk_metadata_tag_t* tag);
