...
extern "C"
{
     ...
     *         dnv_vista_sdk_metadata_tag_string_free, or NULL if `tag` is NULL
     */
     ...
     * @param str String obtained from dnv_vista_sdk_metadata_tag_to_string, may be NULL (no-op)
     */
    DNV_VISTA_SDK_C_API void dnv_vista_sdk_metadata_tag_string_free(char* str);
