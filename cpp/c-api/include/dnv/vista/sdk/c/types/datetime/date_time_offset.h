...
extern "C"
{
    ...
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_create(
    ...
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_from_date_time(
        dnv_vista_sdk_date_time_t dateTime);

    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_from_ticks(
    ...
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_t dnv_vista_sdk_date_time_offset_date_time(
        dnv_vista_sdk_date_time_offset_t dto);
    DNV_VISTA_SDK_C_API dnv_vista_sdk_time_span_t dnv_vista_sdk_date_time_offset_offset(
        dnv_vista_sdk_date_time_offset_t dto);
    /** @brief Equivalent UTC DateTime */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_t dnv_vista_sdk_date_time_offset_utc_date_time(
        dnv_vista_sdk_date_time_offset_t dto);
    /** @brief Equivalent local DateTime (system timezone) */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_t dnv_vista_sdk_date_time_offset_local_date_time(
        dnv_vista_sdk_date_time_offset_t dto);
    ...
    DNV_VISTA_SDK_C_API int32_t dnv_vista_sdk_date_time_offset_total_offset_minutes(
        dnv_vista_sdk_date_time_offset_t dto);

    DNV_VISTA_SDK_C_API int64_t dnv_vista_sdk_date_time_offset_to_epoch_seconds(dnv_vista_sdk_date_time_offset_t dto);
    DNV_VISTA_SDK_C_API int64_t dnv_vista_sdk_date_time_offset_to_epoch_milliseconds(
        dnv_vista_sdk_date_time_offset_t dto);
    /** @brief Date component with time set to 00:00:00 */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_date(
        dnv_vista_sdk_date_time_offset_t dto);
    /** @brief Elapsed time since midnight */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_time_span_t dnv_vista_sdk_date_time_offset_time_of_day(
        dnv_vista_sdk_date_time_offset_t dto);

    /** @brief Convert to a different UTC offset, representing the same instant */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_to_offset(
        dnv_vista_sdk_date_time_offset_t dto, dnv_vista_sdk_time_span_t newOffset);
    /** @brief Convert to UTC (offset = 00:00:00) */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_to_universal_time(
        dnv_vista_sdk_date_time_offset_t dto);
    /** @brief Convert to local time (system timezone) */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_to_local_time(
        dnv_vista_sdk_date_time_offset_t dto);
    ...
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_add_time_span(
        dnv_vista_sdk_date_time_offset_t dto, dnv_vista_sdk_time_span_t value);
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_add_days(
        dnv_vista_sdk_date_time_offset_t dto, double days);
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_add_hours(
        dnv_vista_sdk_date_time_offset_t dto, double hours);
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_add_minutes(
        dnv_vista_sdk_date_time_offset_t dto, double minutes);
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_add_seconds(
        dnv_vista_sdk_date_time_offset_t dto, double seconds);
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_add_milliseconds(
        dnv_vista_sdk_date_time_offset_t dto, double milliseconds);
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_add_months(
        dnv_vista_sdk_date_time_offset_t dto, int32_t months);
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_add_years(
        dnv_vista_sdk_date_time_offset_t dto, int32_t years);
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_add_ticks(
    ...
    DNV_VISTA_SDK_C_API dnv_vista_sdk_time_span_t dnv_vista_sdk_date_time_offset_subtract(
    ...
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_from_epoch_seconds(
        int64_t seconds);
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_from_epoch_milliseconds(
        int64_t milliseconds);
    /** @brief From Windows FILETIME (100-nanosecond intervals since January 1, 1601 UTC) */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_date_time_offset_t dnv_vista_sdk_date_time_offset_from_filetime(
        int64_t filetime);

    /**
     * @brief Convert to string representation using the specified format
     * @return Owned, null-terminated string, must be released with dnv_vista_sdk_date_time_offset_string_free
     */
     ...
     * @param str String obtained from dnv_vista_sdk_date_time_offset_to_string, may be NULL (no-op)
     */
    DNV_VISTA_SDK_C_API void dnv_vista_sdk_date_time_offset_string_free(char* str);
