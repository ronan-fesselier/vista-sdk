...
extern "C"
{
     ...
     * @return Owned, null-terminated string, must be released with dnv_vista_sdk_time_span_string_free
     */
     ...
     * @param str String obtained from dnv_vista_sdk_time_span_to_string, may be NULL (no-op)
     */
    DNV_VISTA_SDK_C_API void dnv_vista_sdk_time_span_string_free(char* str);
