...
#include "gmod_path_query.h"
#include "gmod_path_query_builder.h"
#include "local_id_query.h"
...
extern "C"
{
    ...
    /**
     * @brief Set the primary item query from a Nodes-variant GmodPathQueryBuilder (build() called internally)
     * @param builder Handle obtained from this API
     * @param nodesBuilder Nodes-variant handle obtained from dnv_vista_sdk_gmod_path_query_builder_create
     * @return New owned handle with the primary item set, or NULL if `builder`/`nodesBuilder`
     *         is NULL or `nodesBuilder` is not a Nodes-variant handle
     */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_local_id_query_builder_t*
    dnv_vista_sdk_local_id_query_builder_with_primary_item_nodes_builder(
        const dnv_vista_sdk_local_id_query_builder_t* builder,
        const dnv_vista_sdk_gmod_path_query_builder_t* nodesBuilder);

    /**
     * @brief Set the primary item query from a Path-variant GmodPathQueryBuilder (build() called internally)
     * @param builder Handle obtained from this API
     * @param pathBuilder Path-variant handle obtained from dnv_vista_sdk_gmod_path_query_builder_from
     * @return New owned handle with the primary item set, or NULL if `builder`/`pathBuilder`
     *         is NULL or `pathBuilder` is not a Path-variant handle
     */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_local_id_query_builder_t*
    dnv_vista_sdk_local_id_query_builder_with_primary_item_path_builder(
        const dnv_vista_sdk_local_id_query_builder_t* builder,
        const dnv_vista_sdk_gmod_path_query_builder_t* pathBuilder);
    ...
    /**
     * @brief Set the secondary item query from a Nodes-variant GmodPathQueryBuilder (build() called internally)
     * @param builder Handle obtained from this API
     * @param nodesBuilder Nodes-variant handle obtained from dnv_vista_sdk_gmod_path_query_builder_create
     * @return New owned handle with the secondary item set, or NULL if `builder`/`nodesBuilder`
     *         is NULL or `nodesBuilder` is not a Nodes-variant handle
     */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_local_id_query_builder_t*
    ...
    /**
     * @brief Set the secondary item query from a Path-variant GmodPathQueryBuilder (build() called internally)
     * @param builder Handle obtained from this API
     * @param pathBuilder Path-variant handle obtained from dnv_vista_sdk_gmod_path_query_builder_from
     * @return New owned handle with the secondary item set, or NULL if `builder`/`pathBuilder`
     *         is NULL or `pathBuilder` is not a Path-variant handle
     */
    DNV_VISTA_SDK_C_API dnv_vista_sdk_local_id_query_builder_t*
    dnv_vista_sdk_local_id_query_builder_with_secondary_item_path_builder(
        const dnv_vista_sdk_local_id_query_builder_t* builder,
        const dnv_vista_sdk_gmod_path_query_builder_t* pathBuilder);
    ...
    /**
     * @brief Get the metadata tags query builder, if tags are configured
     * @param builder Handle obtained from this API
     * @return Borrowed pointer to the tags query builder, valid as long as `builder` is valid,
     *         or NULL if `builder` is NULL or no tags query is configured
     */
    DNV_VISTA_SDK_C_API const dnv_vista_sdk_metadata_tags_query_builder_t*
    dnv_vista_sdk_local_id_query_builder_tags_builder(const dnv_vista_sdk_local_id_query_builder_t* builder);
