...
namespace dnv::vista::sdk
{
	...
	inline FormatDataType::Value::DateTime::DateTime( std::chrono::system_clock::time_point value ) noexcept
		: m_value{ value }
	{
	}
	...
	inline const std::chrono::system_clock::time_point& FormatDataType::Value::DateTime::value() const noexcept
	{
		return m_value;
	}
