...
namespace dnv::vista::sdk
{
	...
	/** @brief Standard decimal type alias for high-precision arithmetic */
	using decimal = datatypes::Decimal128;
	...
	public:
		...
		//----------------------------------------------
		// Value types for different data formats
		//----------------------------------------------
		...
		public:
			...
			{
			public:
				inline explicit Decimal( const decimal& value ) noexcept;
				inline explicit Decimal( double value ) noexcept;
				[[nodiscard]] inline const decimal& value() const noexcept;
			...
			{
			public:
				inline explicit DateTime( std::chrono::system_clock::time_point value ) noexcept;
				[[nodiscard]] inline const std::chrono::system_clock::time_point& value() const noexcept;
		...
		private:
			...
			std::variant<String, Char, Boolean, Integer, UnsignedInteger, Long, Double, Decimal, DateTime> m_value{ String{ "" } };
		};
		...
		public:
			/**
			 * @brief Successful validation result
			 */
			class Ok final
			{
			public:
			...
			/**
			 * @brief Failed validation result
			 */
			class Invalid final
			{
			public:
		...
		inline void switchOn(
			...
			DecimalFunc&& onDecimal,
			IntegerFunc&& onInteger,
			BooleanFunc&& onBoolean,
			StringFunc&& onString,
