...
namespace dnv::vista::sdk::datatypes
{
	...
	inline constexpr Int128::Int128() noexcept : m_value{ 0 }
	{
	}

	inline constexpr Int128::Int128( VISTA_SDK_CPP_INT128 val ) noexcept : m_value{ val }
	{
	}
	...
	inline constexpr Int128::Int128( std::uint64_t val ) noexcept : m_value{ val }
	{
	}

	inline constexpr Int128::Int128( std::int64_t val ) noexcept : m_value{ val }
	{
	}

	inline constexpr Int128::Int128( std::uint32_t val ) noexcept : m_value{ val }
	{
	}

	inline constexpr Int128::Int128( int val ) noexcept : m_value{ val }
	{
	}
	...
	inline Int128 Int128::operator*( const Int128& other ) const noexcept
	{
		...
		std::uint64_t result_high = p3 + ( p1 >> 32 ) + ( p2 >> 32 ) + carry +
									m_upper64bits * other.m_lower64bits + m_lower64bits * other.m_upper64bits;
	...
	inline Int128 Int128::operator/( const Int128& other ) const
	{
		 ...
		 */
		double dividend = static_cast<double>( m_upper64bits ) * ( 1ULL << 32 ) * ( 1ULL << 32 ) +
						  static_cast<double>( m_lower64bits );
		double divisor = static_cast<double>( other.m_upper64bits ) * ( 1ULL << 32 ) * ( 1ULL << 32 ) +
						 static_cast<double>( other.m_lower64bits );
