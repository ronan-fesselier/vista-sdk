...
namespace dnv::vista::sdk
{
    ...
    public:
         ...
         */
        DNV_VISTA_SDK_CPP_API DateTime(std::int32_t year, std::int32_t month, std::int32_t day) noexcept;
         ...
         */
        DNV_VISTA_SDK_CPP_API DateTime(
            std::int32_t year,
            std::int32_t month,
            std::int32_t day,
            std::int32_t hour,
        ...
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::int32_t year() const noexcept;   ///< Year component (1-9999)
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::int32_t month() const noexcept;  ///< Month component (1-12)
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::int32_t day() const noexcept;    ///< Day component (1-31)
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::int32_t hour() const noexcept;   ///< Hour component (0-23)
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::int32_t minute() const noexcept; ///< Minute component (0-59)
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::int32_t second() const noexcept; ///< Second component (0-59)
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::int32_t millisecond()
            const noexcept; ///< Millisecond component (0-999)
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::int32_t microsecond()
            const noexcept; ///< Microsecond component (0-999)
         ...
         */
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::int32_t nanosecond() const noexcept;

        [[nodiscard]] constexpr std::int64_t ticks()
            const noexcept; ///< 100-nanosecond intervals since January 1, 0001 UTC
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::int32_t dayOfWeek()
            const noexcept; ///< Day of week (0=Sunday, 6=Saturday)
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::int32_t dayOfYear() const noexcept; ///< Day of year (1-366)
        ...
        [[nodiscard]] DNV_VISTA_SDK_CPP_API DateTime
        date() const noexcept; ///< Date component with time set to 00:00:00
        [[nodiscard]] DNV_VISTA_SDK_CPP_API TimeSpan timeOfDay() const noexcept; ///< Elapsed time since midnight

        [[nodiscard]] DNV_VISTA_SDK_CPP_API DateTime addDays(double days) const noexcept;
        [[nodiscard]] DNV_VISTA_SDK_CPP_API DateTime addHours(double hours) const noexcept;
        [[nodiscard]] DNV_VISTA_SDK_CPP_API DateTime addMinutes(double minutes) const noexcept;
        [[nodiscard]] DNV_VISTA_SDK_CPP_API DateTime addSeconds(double seconds) const noexcept;
        [[nodiscard]] DNV_VISTA_SDK_CPP_API DateTime addMilliseconds(double milliseconds) const noexcept;
         ...
         */
        [[nodiscard]] DNV_VISTA_SDK_CPP_API DateTime addMonths(std::int32_t months) const noexcept;
         ...
         */
        [[nodiscard]] DNV_VISTA_SDK_CPP_API DateTime addYears(std::int32_t years) const noexcept;
         ...
         */
        [[nodiscard]] static DNV_VISTA_SDK_CPP_API DateTime utcNow() noexcept;
        ...
        [[nodiscard]] static DNV_VISTA_SDK_CPP_API bool fromString(
            std::string_view iso8601String, DateTime& result) noexcept;
         ...
         */
        [[nodiscard]] static DNV_VISTA_SDK_CPP_API std::optional<DateTime> fromString(
         ...
         */
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::string toString(Format format = Format::Iso8601) const;
         ...
         * @param format The format to use for string conversion
         */
        DNV_VISTA_SDK_CPP_API void toString(StringBuilder& builder, Format format = Format::Iso8601) const;
         ...
         */
        [[nodiscard]] DNV_VISTA_SDK_CPP_API std::chrono::system_clock::time_point toChrono() const noexcept;
         ...
         */
        [[nodiscard]] static DNV_VISTA_SDK_CPP_API DateTime
        fromChrono(const std::chrono::system_clock::time_point& timePoint) noexcept;

    private:
        std::int64_t m_ticks; ///< 100-nanosecond ticks since January 1, 0001 UTC
    };

    DNV_VISTA_SDK_CPP_API std::ostream& operator<<(std::ostream& os, const DateTime& dateTime);
    DNV_VISTA_SDK_CPP_API std::istream& operator>>(std::istream& is, DateTime& dateTime);
} // namespace dnv::vista::sdk
