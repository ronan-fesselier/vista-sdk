...
export class LocalId {
  ...
  public static parse(localIdStr: string, gmod: Gmod, codebooks: Codebooks, errorBuilder?: LocalIdErrorBuilder) {
    return LocalIdParser.parse(localIdStr, gmod, codebooks, errorBuilder).build();
  }
}
