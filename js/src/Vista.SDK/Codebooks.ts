import { Codebook, CodebookName, MetadataTag } from '.';
...
export class Codebooks {
  ...
  public constructor(visVersion: VisVersion, dto: CodebooksDto) {
    ...
    const detailsCodebook = new Codebook({ name: 'detail', values: {} } as CodebookDto);
  ...
  public tryCreateTag(name: CodebookName, value?: string): MetadataTag | undefined {
