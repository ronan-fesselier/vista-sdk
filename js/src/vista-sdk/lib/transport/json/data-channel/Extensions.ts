import { Defaults, LocalId, VIS } from "../../..";
    ...
    public static toJsonDto(
        ...
        return {
            Package: {
                ...
                DataChannelList: {
                    DataChannel: p.dataChannelList.dataChannel.map((c) => ({
                        DataChannelID: {
                            ...
                            Format: {
                                ...
                                Restriction: {
                                    ...
                                    FractionDigits:
                                        c.property.format.restriction
                                            .fractionDigits,
                                    Length: c.property.format.restriction
                                        .length,
                                    MaxExclusive:
                                        c.property.format.restriction
                                            .maxExclusive,
