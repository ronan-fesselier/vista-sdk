...
fn bench(c: &mut Criterion) {
    ...
    c.bench_function("FromShortPath", |b| {
        b.iter(|| {
            ...
            GmodPath::from_short_path(SHORT_PATHS[i], gmod, locations)
        })
    });
    ...
    c.bench_function("FromFullPath", |b| {
        b.iter(|| {
            ...
            GmodPath::from_full_path(FULL_PATHS[i], gmod, locations)
        })
    });
    ...
    c.bench_function("FromShortPathIndividualized", |b| {
        b.iter(|| {
            ...
            GmodPath::from_short_path(SHORT_PATHS_INDIVIDUALIZED[i], gmod, locations)
        })
    });
    ...
    c.bench_function("FromFullPathIndividualized", |b| {
        b.iter(|| {
            ...
            GmodPath::from_full_path(FULL_PATHS_INDIVIDUALIZED[i], gmod, locations)
        })
    });
}
