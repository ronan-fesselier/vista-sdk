...
fn bench(c: &mut Criterion) {
    ...
    c.bench_function("FromShortPath", |b| {
        b.iter(|| {
            ...
            black_box(GmodPath::from_short_path(
                black_box(SHORT_PATHS[i]),
                gmod,
                locations,
            ))
        })
    ...
    c.bench_function("FromFullPath", |b| {
        b.iter(|| {
            ...
            black_box(GmodPath::from_full_path(
                black_box(FULL_PATHS[i]),
                gmod,
                locations,
            ))
        })
    ...
    c.bench_function("FromShortPathIndividualized", |b| {
        b.iter(|| {
            ...
            black_box(GmodPath::from_short_path(
                black_box(SHORT_PATHS_INDIVIDUALIZED[i]),
                gmod,
                locations,
            ))
        })
    ...
    c.bench_function("FromFullPathIndividualized", |b| {
        b.iter(|| {
            ...
            black_box(GmodPath::from_full_path(
                black_box(FULL_PATHS_INDIVIDUALIZED[i]),
                gmod,
                locations,
            ))
        })
