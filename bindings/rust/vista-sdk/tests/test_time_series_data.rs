...
fn create_valid_fully_custom_dcl() -> DataChannelListPackage {
    ...
    header.set_date_created("2015-12-01T00:00:00Z".parse::<DateTimeOffset>().unwrap());
...
fn time_span_invalid_range_returns_err() {
    ...
    ts.set_start("2016-01-04T12:00:00Z".parse::<DateTimeOffset>().unwrap());
    assert!(ts.start().to_string() != "2016-01-04T12:00:00+00:00");
    ts.set_end("2015-12-31T12:00:00Z".parse::<DateTimeOffset>().unwrap());
