...
fn parse_invalid_string_returns_none() {
    ...
    assert!(locations.from_string("not-a-location").is_none());
}
...
fn parse_with_errors_valid_string_yields_empty_errors() {
    ...
    let (location, errors) = locations.from_string_with_errors("11FIPU");
...
fn parse_with_errors_invalid_string_yields_non_empty_errors() {
    ...
    let (location, errors) = locations.from_string_with_errors("not-a-location");
