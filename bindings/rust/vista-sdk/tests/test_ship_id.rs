...
fn equality_imo_numbers() {
    let imo1 = "9074729".parse::<ImoNumber>().unwrap();
    let imo2 = "9074729".parse::<ImoNumber>().unwrap();
    let imo3 = "1234567".parse::<ImoNumber>().unwrap();
...
fn equality_imo_vs_alternative() {
    let imo = "9074729".parse::<ImoNumber>().unwrap();
