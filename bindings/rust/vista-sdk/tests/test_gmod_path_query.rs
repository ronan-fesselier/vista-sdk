...
fn path_builder_always_matches_itself() {
    ...
    let path =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("411.1-1/C101", gmod, locations)
            .expect("411.1-1/C101 should parse");

    let query = GmodPathQueryBuilder::from_path(&path)
...
fn path_builder_parametrized() {
    ...
    for (path_str, version, parameters, expected_match) in cases {
        ...
        let path = vista_sdk::core::gmod_path::GmodPath::from_short_path(path_str, gmod, locations)
            .unwrap_or_else(|| panic!("valid path should parse: {path_str}"));

        let mut builder =
            GmodPathQueryBuilder::from_path(&path).unwrap_or_else(|e| panic!("{path_str}: {e:?}"));
...
fn nodes_builder_parametrized() {
    ...
    for (path_str, version, parameters, expected_match) in cases {
        ...
        let mut builder = GmodPathQueryBuilder::create();
...
fn with_any_node_before_ignores_parent_nodes() {
    ...
    let base_path =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("411.1/C101.31", gmod, locations)
            .expect("411.1/C101.31 should parse");

    let query = GmodPathQueryBuilder::from_path(&base_path)
        .expect("path builder should build")
    ...
    let path_diff_parent =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("511.11/C101.31", gmod, locations)
            .expect("511.11/C101.31 should parse");
    assert!(query.match_path(&path_diff_parent));

    let path_with_loc =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("411.1/C101.31-2", gmod, locations)
            .expect("411.1/C101.31-2 should parse");
    assert!(query.match_path(&path_with_loc));

    let path_diff_c_node =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("411.1/C102.31", gmod, locations)
...
fn with_any_node_before_matches_any_parent_for_sensor() {
    ...
    let sensor_path = vista_sdk::core::gmod_path::GmodPath::from_short_path(
        "411.1/C101.63/S206",
        gmod,
        locations,
    )
    ...
    let query = GmodPathQueryBuilder::from_path(&sensor_path)
        .expect("path builder should build")
        .without_locations()
        .expect("without_locations should succeed")
    ...
    let path_loc1 = vista_sdk::core::gmod_path::GmodPath::from_short_path(
        "411.1-1/C101.63/S206",
        gmod,
        locations,
    )
    .expect("411.1-1/C101.63/S206 should parse");
    let path_loc2 = vista_sdk::core::gmod_path::GmodPath::from_short_path(
    ...
    let path_c10131 =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("411.1/C101.31-2", gmod, locations)
            .expect("411.1/C101.31-2 should parse");
    let path_s203 = vista_sdk::core::gmod_path::GmodPath::from_short_path(
        "411.1/C101.61/S203",
        gmod,
        locations,
    )
...
fn with_any_node_before_preserves_location_requirement_on_target_node() {
    ...
    let base_path =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("433.1-P/C322.31", gmod, locations)
    ...
    let path_diff_parent_loc =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("433.1-S/C322.31", gmod, locations)
            .expect("433.1-S/C322.31 should parse");
    assert!(query.match_path(&path_diff_parent_loc));

    let path_no_parent_loc =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("433.1/C322.31", gmod, locations)
...
fn with_any_node_after_ignores_children_via_prefix_matching() {
    ...
    let path_c10131 =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("411.1/C101.31-2", gmod, locations)
            .expect("411.1/C101.31-2 should parse");
    let path_s206 = vista_sdk::core::gmod_path::GmodPath::from_short_path(
        "411.1/C101.63/S206",
        gmod,
        locations,
    )
    ...
    let path_511 = vista_sdk::core::gmod_path::GmodPath::from_short_path(
        "511.11/C101.63/S206",
        gmod,
        locations,
    )
    ...
    let path_652 =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("652.31/S90.3/S61", gmod, locations)
...
fn with_any_node_after_ignores_suffix_mid_path() {
    ...
    let base_path = vista_sdk::core::gmod_path::GmodPath::from_short_path(
        "411.1/C101.63/S206",
        gmod,
        locations,
    )
    ...
    .expect("411.1/C101.63/S206 should parse");
    let path_loc = vista_sdk::core::gmod_path::GmodPath::from_short_path(
        "411.1-1/C101.61/S203",
        gmod,
        locations,
    )
...
fn with_any_node_after_errors_when_node_not_in_path() {
    ...
    let builder = GmodPathQueryBuilder::from_path(&base_path)
        .expect("path builder should build")
        .without_locations()
        .expect("without_locations should succeed");
    ...
    let safe_query = GmodPathQueryBuilder::from_path(&base_path)
        .expect("path builder should build")
        .without_locations()
        .expect("without_locations should succeed")
        .build();
...
fn without_locations_ignores_location_individualization() {
    ...
    let base_path =
        vista_sdk::core::gmod_path::GmodPath::from_short_path("411.1-1/C101.31", gmod, locations)
...
fn builder_immutability_returns_new_builder() {
    ...
    let builder1 = GmodPathQueryBuilder::from_path(&path).expect("path builder should build");
