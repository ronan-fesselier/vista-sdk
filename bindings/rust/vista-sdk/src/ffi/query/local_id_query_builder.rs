...
use super::gmod_path_query_builder::dnv_vista_sdk_gmod_path_query_builder_t;
...
extern "C" {
    ...
    pub(crate) fn dnv_vista_sdk_local_id_query_builder_with_primary_item_nodes_builder(
        builder: *const dnv_vista_sdk_local_id_query_builder_t,
        nodes_builder: *const dnv_vista_sdk_gmod_path_query_builder_t,
    ) -> *mut dnv_vista_sdk_local_id_query_builder_t;
    pub(crate) fn dnv_vista_sdk_local_id_query_builder_with_primary_item_path_builder(
        builder: *const dnv_vista_sdk_local_id_query_builder_t,
        path_builder: *const dnv_vista_sdk_gmod_path_query_builder_t,
    ) -> *mut dnv_vista_sdk_local_id_query_builder_t;
    ...
    pub(crate) fn dnv_vista_sdk_local_id_query_builder_with_secondary_item_nodes_builder(
        builder: *const dnv_vista_sdk_local_id_query_builder_t,
        nodes_builder: *const dnv_vista_sdk_gmod_path_query_builder_t,
    ) -> *mut dnv_vista_sdk_local_id_query_builder_t;
    pub(crate) fn dnv_vista_sdk_local_id_query_builder_with_secondary_item_path_builder(
        builder: *const dnv_vista_sdk_local_id_query_builder_t,
        path_builder: *const dnv_vista_sdk_gmod_path_query_builder_t,
    ) -> *mut dnv_vista_sdk_local_id_query_builder_t;
    ...
    pub(crate) fn dnv_vista_sdk_local_id_query_builder_tags_builder(
        builder: *const dnv_vista_sdk_local_id_query_builder_t,
