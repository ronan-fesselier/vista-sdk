...
#[repr(C)]
pub(crate) struct dnv_vista_sdk_tsd_validation_errors_t {
    _opaque: [u8; 0],
}
...
pub(crate) type DnvVistaSdkTsdValidateCallbackT = unsafe extern "C" fn(
    ...
    out_errors: *mut dnv_vista_sdk_tsd_validation_errors_t,
...
extern "C" {
    ...
    pub(crate) fn dnv_vista_sdk_tsd_validation_errors_add(
        errors: *mut dnv_vista_sdk_tsd_validation_errors_t,
