...
extern "C" {
    ...
    pub(crate) fn dnv_vista_sdk_serializable_document_array_at_mut(
        doc: *mut dnv_vista_sdk_serializable_document_t,
        index: usize,
    ) -> *mut dnv_vista_sdk_serializable_document_t;
    ...
    pub(crate) fn dnv_vista_sdk_serializable_document_object_value_at_mut(
        doc: *mut dnv_vista_sdk_serializable_document_t,
        index: usize,
    ) -> *mut dnv_vista_sdk_serializable_document_t;
    ...
    pub(crate) fn dnv_vista_sdk_serializable_document_find_mut(
        doc: *mut dnv_vista_sdk_serializable_document_t,
        key: *const c_char,
    ) -> *mut dnv_vista_sdk_serializable_document_t;
