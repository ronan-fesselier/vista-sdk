...
impl Codebook {
    ...
    pub(crate) unsafe fn from_ptr<'a>(ptr: *const ffi::dnv_vista_sdk_codebook_t) -> &'a Self {
        // SAFETY: caller guarantees ptr is non-null and valid. `Codebook` is `#[repr(transparent)]`.
    ...
    pub fn has_group(&self, group: &str) -> bool {
        ...
        // SAFETY: self is non-null, and c_group is a valid NUL-terminated C string.
        unsafe {
    ...
    pub fn validate_position(&self, position: &str) -> PositionValidationResult {
        ...
        // SAFETY: self is non-null, and c_pos is a valid NUL-terminated C string.
        let raw = unsafe {
...
// SAFETY: Codebook is a borrowed view (`repr(transparent)`). Sync only, not Send.
unsafe impl Sync for Codebook {}
...
mod discriminant_sync {
    ...
    #[test]
    fn position_validation_result_discriminants_match_ffi() {
        assert_eq!(
            PositionValidationResult::Invalid as u32,
            ffi::dnv_vista_sdk_position_validation_result_t::Invalid as u32
        );
        assert_eq!(
            PositionValidationResult::InvalidOrder as u32,
            ffi::dnv_vista_sdk_position_validation_result_t::InvalidOrder as u32
        );
        assert_eq!(
            PositionValidationResult::InvalidGrouping as u32,
            ffi::dnv_vista_sdk_position_validation_result_t::InvalidGrouping as u32
        );
        assert_eq!(
            PositionValidationResult::Valid as u32,
            ffi::dnv_vista_sdk_position_validation_result_t::Valid as u32
        );
        assert_eq!(
            PositionValidationResult::Custom as u32,
            ffi::dnv_vista_sdk_position_validation_result_t::Custom as u32
        );
    }
}
