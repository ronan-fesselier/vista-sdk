...
impl GmodPathRef {
    pub(crate) fn from_ptr<'a>(ptr: *const ffi::dnv_vista_sdk_gmod_path_t) -> &'a Self {
        ...
        // SAFETY: ptr is non-null and `GmodPathRef` is `#[repr(transparent)]` over the FFI type.
...
impl std::ops::Deref for GmodPath {
    ...
    fn deref(&self) -> &GmodPathRef {
        GmodPathRef::from_ptr(self.0.as_ptr())
    }
}
