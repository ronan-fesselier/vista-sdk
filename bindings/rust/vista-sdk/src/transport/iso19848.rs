...
// SAFETY: DataChannelTypeNames, FormatDataType, FormatDataTypes own their heap-allocated
// C++ objects exclusively.
unsafe impl Send for DataChannelTypeNames {}
unsafe impl Sync for DataChannelTypeNames {}
unsafe impl Send for FormatDataType {}
unsafe impl Sync for FormatDataType {}
unsafe impl Send for FormatDataTypes {}
unsafe impl Sync for FormatDataTypes {}

// SAFETY: Iso19848 holds a *const to a library-managed singleton that is immutable after
// initialization and valid for the program lifetime.
unsafe impl Send for Iso19848 {}
unsafe impl Sync for Iso19848 {}
