...
// SAFETY: called by the C API with `userdata` as passed below (a live `*mut CallbackState`
// borrowed from a local in `validate`) and other arguments valid for the call's duration.
