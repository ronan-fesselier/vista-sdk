...
mod discriminant_sync {
    ...
    #[test]
    fn rounding_mode_discriminants_match_ffi() {
        assert_eq!(
            RoundingMode::ToNearest as u32,
            ffi::dnv_vista_sdk_decimal_rounding_mode_t::ToNearest as u32
        );
        assert_eq!(
            RoundingMode::ToNearestTiesAway as u32,
            ffi::dnv_vista_sdk_decimal_rounding_mode_t::ToNearestTiesAway as u32
        );
        assert_eq!(
            RoundingMode::ToZero as u32,
            ffi::dnv_vista_sdk_decimal_rounding_mode_t::ToZero as u32
        );
        assert_eq!(
            RoundingMode::ToPositiveInfinity as u32,
            ffi::dnv_vista_sdk_decimal_rounding_mode_t::ToPositiveInfinity as u32
        );
        assert_eq!(
            RoundingMode::ToNegativeInfinity as u32,
            ffi::dnv_vista_sdk_decimal_rounding_mode_t::ToNegativeInfinity as u32
        );
    }
}
