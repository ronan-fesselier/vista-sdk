...
fn main() {
...

    {
        ...
        let source_path1 =
            GmodPath::from_short_path("323.51/H362.1", source_gmod, source_locations);
        ...
        let source_path2 = GmodPath::from_short_path(
...

    {
        ...
        let source_path = GmodPath::from_short_path("511.331/C221", source_gmod, source_locations);
        ...
        if let Some(source_path) = source_path {
            ...
            match target_path {
                Ok(target_path) => {
                    ...
                    let expected = GmodPath::from_short_path(
                        "511.31/C121.31/C221",
                        target_gmod,
                        target_locations,
                    );
...

    {
        ...
        let source_path =
            GmodPath::from_short_path("691.811i-A/H101.11-1", source_gmod, source_locations);
...

    {
        ...
        for path_str in path_strings {
            let source_path = GmodPath::from_short_path(path_str, source_gmod, source_locations);
            if let Some(source_path) = source_path {
...

    {
        ...
        let source_local_id = LocalId::from_string(source_local_id_str);
        ...
        let source_local_id2 = LocalId::from_string(source_local_id_str2);
...

    {
        ...
        let current_path = GmodPath::from_short_path(start_path, start_gmod, start_locations);

        if let Some(mut current_path) = current_path {
