...
fn main() {
...

    {
        ...
        if let Some(path1) = GmodPath::from_short_path("411.1", gmod, locations) {
        ...
        if let Some(path2) = GmodPath::from_short_path("411.1-1P", gmod, locations) {
            println!("\nParsed: \"411.1-1P\"");
        ...
        if let Some(path3) = GmodPath::from_short_path("612.21-1/C701.13/S93", gmod, locations) {
        ...
        let (path4, errors) =
            GmodPath::from_short_path_with_errors("C101.63-2P/S206.22", gmod, locations);
...

    {
        ...
        if let Some(path) =
            GmodPath::from_full_path("VE/400a/410/411/411i/411.1-1P", gmod, locations)
        {
        ...
        // Complex full path
        if let Some(path2) = GmodPath::from_full_path(
...

    {
        ...
        for path_str in invalid_paths {
            let (path, errors) = GmodPath::from_short_path_with_errors(path_str, gmod, locations);
...

    {
        ...
        if let Some(path) = GmodPath::from_full_path(
            "VE/600a/610/612/612.2/612.2i-1/612.21-1/CS10/C701/C701.1/C701.13/S93",
            gmod,
            locations,
        ) {
...

    {
        ...
        if let Some(path) = GmodPath::from_short_path("411.1/C101.62/S205", gmod, locations) {
            println!("Path: {}", path);
            ...
            if let Some(ind_path) =
                GmodPath::from_short_path("411.1-1/C101.62/S205", gmod, locations)
            {
...

    {
        ...
        // Parse short path
        if let Some(short_path) = GmodPath::from_short_path("411.1-1P", gmod, locations) {
...

    {
        ...
        let path1 = GmodPath::from_short_path("411.1-1P", gmod, locations);
        let path2 = GmodPath::from_full_path("VE/400a/410/411/411i/411.1-1P", gmod, locations);
        let path3 = GmodPath::from_short_path("411.1-2P", gmod, locations);
...

    {
        ...
        if let Some(path1) = GmodPath::from_short_path("411.1-1P", gmod, locations) {
            let node = path1.node();
            println!("Path                 : {}", path1);
        ...
        if let Some(path2) = GmodPath::from_short_path("612.21-1/C701.13/S93", gmod, locations) {
            let node = path2.node();
            println!("\nPath      : {}", path2);
