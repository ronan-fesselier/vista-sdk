...
fn main() {
...

    {
        ...
        if let Ok(imo) = "9074729".parse::<ImoNumber>() {
...

    {
        ...
        let imo1 = "9074729".parse::<ImoNumber>().expect("9074729 is valid");
        let imo2 = "9074729".parse::<ImoNumber>().expect("9074729 is valid");
        let imo3 = "9785811".parse::<ImoNumber>().expect("9785811 is valid");
