...
fn main() {
...

    {
        ...
        let iso = Iso19848::instance();
        let types = iso.format_data_types(Iso19848Version::V2024).unwrap();
        let decimal_type = types.find("Decimal").unwrap();
...

    {
        ...
        let iso = Iso19848::instance();
        let types = iso.format_data_types(Iso19848Version::V2024).unwrap();
        let integer_type = types.find("Integer").unwrap();
...

    {
        ...
        let bool_type = types.find("Boolean").unwrap();
        ...
        let string_type = types.find("String").unwrap();
...

    {
        ...
        let iso = Iso19848::instance();
        let types = iso.format_data_types(Iso19848Version::V2024).unwrap();
        let dt_type = types.find("DateTime").unwrap();
...

    {
        ...
        for r in &readings {
            ...
            match format_types.find(r.data_type) {
