...
fn main() {
...

    {
        ...
        let cooling_water_outlet = "87.3".parse::<Decimal>().expect("valid");
        let cooling_water_inlet = "72.1".parse::<Decimal>().expect("valid");
        let delta_t = cooling_water_outlet - cooling_water_inlet;

        let scavenge_air_pressure = "2.847".parse::<Decimal>().expect("valid");
        let exhaust_gas_temp = "342.6".parse::<Decimal>().expect("valid");
...

    {
        ...
        let fuel_consumption_per_day = "45.72".parse::<Decimal>().expect("valid");
        let voyage_days = Decimal::from_i64(12);
        let total_fuel = fuel_consumption_per_day * voyage_days;

        let fuel_density = "0.8914".parse::<Decimal>().expect("valid");
...

    {
        ...
        let speed_over_ground = "14.3".parse::<Decimal>().expect("valid");
        let speed_through_water = "13.8".parse::<Decimal>().expect("valid");
        let current_effect = speed_over_ground - speed_through_water;

        let distance_to_waypoint = "1247.6".parse::<Decimal>().expect("valid");
...

    {
        ...
        let draught_fwd = "7.843".parse::<Decimal>().expect("valid");
        let draught_aft = "8.126".parse::<Decimal>().expect("valid");
        let mean_draught = (draught_fwd + draught_aft) / Decimal::from_i64(2);
        let trim = draught_aft - draught_fwd;

        let displacement = "23847.5".parse::<Decimal>().expect("valid");
        let kg = "9.214".parse::<Decimal>().expect("valid");
        let km = "10.871".parse::<Decimal>().expect("valid");
        let gm = km - kg;
...

    {
        ...
        let celsius_to_kelvin = "273.15".parse::<Decimal>().expect("valid");

        let sea_water_temp_c = "14.8".parse::<Decimal>().expect("valid");
        let sea_water_temp_k = sea_water_temp_c + celsius_to_kelvin;

        let air_temp_c = "-3.2".parse::<Decimal>().expect("valid");
        let air_temp_k = celsius_to_kelvin + air_temp_c;

        let knots_to_ms = "0.514444".parse::<Decimal>().expect("valid");
        let wind_speed = "18.5".parse::<Decimal>().expect("valid");
        let wind_speed_ms = wind_speed * knots_to_ms;

        let bar_to_kpa = Decimal::from_i64(100);
        let barometric_pressure = "1.0132".parse::<Decimal>().expect("valid");
...

    {
        ...
        let shaft_rpm = "97.4375".parse::<Decimal>().expect("valid");
        ...
        let tied_even = "97.45".parse::<Decimal>().expect("valid");
        let tied_odd = "97.35".parse::<Decimal>().expect("valid");
        ...
        let flow_increment = "0.047".parse::<Decimal>().expect("valid");
