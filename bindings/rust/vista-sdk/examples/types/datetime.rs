...
fn main() {
...

    {
        ...
        let dt1 = "2026-08-22T14:30:45Z".parse::<DateTime>().expect("valid");
        let dt2 = "2026-08-22".parse::<DateTime>().expect("valid");

        println!("Parsed sensor timestamp \"2026-08-22T14:30:45Z\": {dt1}");
        println!("Parsed dry-dock date \"2026-08-22\":              {dt2}");

        match "2026-08-22T00:00:00Z".parse::<DateTime>().ok() {
            Some(result) => {
...

    {
        ...
        let ts1 = "PT1H".parse::<TimeSpan>().expect("valid");
        let ts2 = "PT1H30M45S".parse::<TimeSpan>().expect("valid");
        let ts3 = "P1DT12H".parse::<TimeSpan>().expect("valid");
        let ts4 = "-PT2H30M".parse::<TimeSpan>().expect("valid");
...

    {
        ...
        let dto1 = "2026-08-22T14:30:00+09:00"
            .parse::<DateTimeOffset>()
            .expect("valid");
        let dto2 = "2026-08-22T14:30:00-05:00"
            .parse::<DateTimeOffset>()
            .expect("valid");
        let dto3 = "2026-08-22T14:30:00Z"
            .parse::<DateTimeOffset>()
            .expect("valid");
...

    {
        ...
        let yokohama = "2026-08-22T18:00:00+09:00"
            .parse::<DateTimeOffset>()
            .expect("valid");
...

    {
        ...
        println!(
            ...
            dto.to_string_fmt(DateTimeFormat::Iso8601Extended)
        );
...

    {
        ...
        let yokohama_departure = "2026-08-22T18:00:00+09:00"
            .parse::<DateTimeOffset>()
            .expect("valid");
        let new_york_arrival = "2026-08-22T04:00:00-05:00"
            .parse::<DateTimeOffset>()
            .expect("valid");
...

    {
        ...
        let yokohama = "2026-08-22T18:00:00+09:00"
            .parse::<DateTimeOffset>()
            .expect("valid");
        let new_york = "2026-08-22T04:00:00-05:00"
            .parse::<DateTimeOffset>()
            .expect("valid");
