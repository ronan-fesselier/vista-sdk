...
fn main() {
...

    {
        ...
        let primary_path = GmodPath::from_short_path("411.1/C101.31", gmod, locations);
        let local_id1 =
            LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.31-2/meta/qty-temperature");
        let local_id2 = LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.31-5/meta/qty-pressure");
        let local_id3 = LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.63/meta/qty-temperature");

        if let (Some(primary_path), Some(local_id1), Some(local_id2), Some(local_id3)) =
            (primary_path, local_id1, local_id2, local_id3)
        {
            let path_query = GmodPathQueryBuilder::from_path(&primary_path)
...

    {
        ...
        let local_id1 =
            LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.31-2/meta/qty-temperature");
        let local_id2 = LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.31-2/meta/qty-pressure");
        let local_id3 = LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.63/meta/qty-temperature");
        ...
        {
            let path_query = GmodPathQueryBuilder::create()
...

    {
        ...
        let local_id1 =
            LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.31-2/meta/qty-temperature");
        let local_id2 =
            LocalId::from_string("/dnv-v2/vis-3-4a/621.21/S90/sec/411.1/C101/meta/qty-mass");
...

    {
        ...
        let reference = LocalId::from_string(
        ...
        let local_id3 = LocalId::from_string(
        ...
        {
            let query = LocalIdQueryBuilder::from_local_id(&reference)
...

    {
        ...
        let local_id1 =
            LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.31-2/meta/qty-temperature");
        let local_id2 = LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.63/meta/qty-pressure");
        let local_id3 = LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C102.31/meta/qty-temperature");
...

    {
        ...
        let base_path = GmodPath::from_short_path("411.1/C101.31", gmod, locations);
        let local_id1 =
            LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.31-2/meta/qty-temperature");
        let local_id2 = LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.31-5/meta/qty-pressure");
        let local_id3 = LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.63/meta/qty-temperature");
...

    {
        ...
        let local_id1 =
            LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.31-2/meta/qty-temperature");
        let local_id2 = LocalId::from_string("/dnv-v2/vis-3-4a/411.1/E202.1/E31/meta/qty-pressure");
        let local_id3 = LocalId::from_string("/dnv-v2/vis-3-4a/621.21/S90/meta/qty-temperature");
    ...
    {
        println!("8. LocalIdQuery: primary item via Nodes-variant builder");
        println!(
            "-----------------------------------------------------------------------------------"
        );
        ...
        if let (Some(local_id1), Some(local_id2)) = (local_id1, local_id2) {
            println!("Query: primary item contains C101 (any location)\n");
            println!("Test LocalId 1 (C101.31): {}", local_id1);
            println!("  Matches: {}\n", query.match_local_id(&local_id1));
            println!("Test LocalId 2 (C102.31): {}", local_id2);
            println!("  Matches: {} (no C101)", query.match_local_id(&local_id2));
        }
    ...
    {
        println!("9. LocalIdQuery: accumulating tags via tags_builder");
        println!("------------------------------------------------------");
        ...
        let local_id2 = LocalId::from_string(
            "/dnv-v2/vis-3-4a/652.31/S90.3/S61/sec/652.1i-1P/meta/cnt-sea.water",
        );
        ...
        if let (Some(local_id1), Some(local_id2)) = (local_id1, local_id2) {
            ...
            println!("Query: Match LocalIds with cnt-sea.water AND state-opened\n");

            println!("Test LocalId 1 (both tags): {}", local_id1);
            println!("  Matches: {}\n", query.match_local_id(&local_id1));

            println!("Test LocalId 2 (only cnt-sea.water): {}", local_id2);
            println!("  Matches: {}", query.match_local_id(&local_id2));
        }
