...
fn main() {
...

    {
        ...
        let local_id2 =
            LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.63/meta/qty-pressure/cnt-air");
...

    {
        ...
        let local_id2 = LocalId::from_string("/dnv-v2/vis-3-4a/1021.1i-6P/H123/meta/qty-volume");
...

    {
        ...
        let subset_query = MetadataTagsQueryBuilder::create()
            .with_tag(CodebookName::Quantity, "pressure")
            .with_allow_other_tags(true)
            .build();

        let exact_query = MetadataTagsQueryBuilder::create()
            .with_tag(CodebookName::Quantity, "pressure")
            .with_allow_other_tags(false)
            .build();

        let local_id1 = LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.63/meta/qty-pressure");
        let local_id2 =
            LocalId::from_string("/dnv-v2/vis-3-4a/411.1/C101.63/meta/qty-pressure/cnt-air");
