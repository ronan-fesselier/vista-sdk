...
fn main() {
...

    {
        ...
        let path1 = GmodPath::from_short_path("411.1/C101.31-2", gmod, locations);
        let path2 = GmodPath::from_short_path("411.1/C101.31-5", gmod, locations);
        let path3 = GmodPath::from_short_path("411.1/C101.63", gmod, locations);
...

    {
        ...
        let path1 = GmodPath::from_short_path("411.1-1P/C101.31-2", gmod, locations);
        let path2 = GmodPath::from_short_path("411.1-2P/C101.63", gmod, locations);
        let path3 = GmodPath::from_short_path("511.11/C104", gmod, locations);

        if let (Ok(node411), Ok(node_c101), Some(path1), Some(path2), Some(path3)) =
            (node411, node_c101, path1, path2, path3)
        {
            let query = GmodPathQueryBuilder::create()
...

    {
        ...
        let base_path = GmodPath::from_short_path("411.1/C101.63/S206", gmod, locations);
        let path1 = GmodPath::from_short_path("411.1-1/C101.63/S206", gmod, locations);
        let path2 = GmodPath::from_short_path("411.1-2/C101.63/S206", gmod, locations);
        let path3 = GmodPath::from_short_path("411.1/C101.31-2", gmod, locations);
...

    {
        ...
        let base_path = GmodPath::from_short_path("411.1/C101.31", gmod, locations);
        let path1 = GmodPath::from_short_path("411.1/C101.31-2", gmod, locations);
        let path2 = GmodPath::from_short_path("411.1/C101.63/S206", gmod, locations);
        let path3 = GmodPath::from_short_path("511.11/C104", gmod, locations);
